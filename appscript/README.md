...
- Las ventas cerradas se pueden corregir desde **Ventas** únicamente con el rol Jefe; el servicio recalcula detalle, pagos, inventario e ingresos diarios y conserva el evento en `Auditoria`.
